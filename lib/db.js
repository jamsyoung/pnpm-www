...
cradle.setup({
    host: process.env.COUCHDB_HOST || 'tnpm.cnn.vgtf.net',
...
module.exports = {
    ...
    getRecentlyUpdated: function (data, callback) {
        ...
        viewOptions.include_docs = data.showDetails;
...
/*****************************************************************************/
    ...
    getDataByView: function (data, callback) {
        ...
        if (data && data.query) {
            ...
            if (data.key) {
                viewOptions.key = data.key;
            }

            if (data.keys) {
                viewOptions.keys = data.keys;
            }
